...
/**
 * 
 * @param {websocket.Server<typeof websocket, typeof IncomingMessage>} webSocketServer 
 */
const AddEvents = (webSocketServer) =>{
...
module.exports = {serverConnection,createWebSocketServer,AddEvents,clients}